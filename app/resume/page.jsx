...
const about = {
  title: 'About me',
  description: ' I specialize in building responsive and visually engaging websites using a range of technologies, including HTML, CSS, JavaScript, Tailwind CSS, Bootstrap, React.js, and Next.js. My focus is on creating seamless user experiences that are both functional and aesthetically pleasing, ensuring that every project I work on is optimized for performance and accessibility across all devices.',
  info:[
    {
      fieldName: "Name: ",
...
const experience = {
  ...
  items: [
    ...
    {
      company: "Build Website && Landing pages",
      position: "Front-end",
      duration: "2023 - 2024",
    },
    {
      company: "Build Responsive Websites",
      position: "Freelancer",
      duration: "1019-2020",
    },
    {
...
const education = {
  ...
  items: [
    ...
    {
      institution: "GoMyCode School",
      degree: "Certified Basic Of Web Development",
      duration: "2023 - 2024",
    },
    {
      institution: "GoMyCode School",
